...
class Place(object):
    ...
    def __init__(self, name, exit=None):
        ...
        # BEGIN Problem 2
        "*** YOUR CODE HERE ***"
        if type(self.exit) is Place or type(self.exit) is Water:
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            "*** YOUR CODE HERE ***"
            if type(insect) is QueenAnt and not insect.impostor:
                return None
            # END Problem 13
...
class HungryAnt(Ant):
    ...
    def __init__(self,armor=1,time_to_digest=3):
        # BEGIN Problem 6
        "*** YOUR CODE HERE ***"
        Ant.__init__(self,armor)
        self.time_to_digest = time_to_digest
        self.digesting = 0
        self.eating = False
        # END Problem 6
    ...
    def action(self, colony):
        ...
        if self.impostor:
            ...
            while place.exit is not None:
                if can_double(place.ant):
                    place.ant.damage = place.ant.damage * 2
                    self.doubled.append(place.ant)
                if place.ant is not None and place.ant.container and can_double(place.ant.ant):
