...
def is_swap(score0, score1):
    ...
    if score0 > 1 and score1 > 1:
        return True if max(score0,score1)%min(score0,score1)==0 else False
    else:
        return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            ...
            score = take_turn(strategy, score1, dice)
            score0 = score0 + score

        if player == 1:
            strategy = strategy1(score1,score0)
            score = take_turn(strategy, score0, dice)
            score1 = score1 + score

        score0,score1=check_swap(score0,score1)
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    def points_print(score):
        if score > 1:
            return str(score) + ' points!'
        else:
            return str(score) + ' point!'
    def say_biggest(score):
        if score > previous_high:
            print(points_print(score),"That's the biggest gain yet for Player",who)
            return score
        else:
    ...
    def say(score0,score1):
        if who == 0:
            ...
            pre_high = say_biggest(score)
            return announce_highest(who, pre_high, score0)
        else:
            score = score1 - previous_score
            pre_high = say_biggest(score)
            return announce_highest(who, pre_high, score1)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    result,i,max_avg = 1,1,1
    while i <= 10:
        avg=make_averaged(roll_dice)(i,dice)
        """print('roll' , i ,'avg=',avg)"""
        if max_avg < avg:
            max_avg = avg
            result = i
        i+=1
...
def make_averaged_final(score, fn, num_samples=10):
    """Return a function that returns the average value of FN when called.
    ...
    def cal_average(*args):
        i, total = 0,0
        target_score = 100 - score
        while i < num_samples:
            roll_result = fn(*args)
            if roll_result > target_score:
                roll_result = target_score
...
def num_rolls_final(score, dice=six_sided, num_samples=100):

    result,i,max_avg = 1,1,1
    while i <= 10:
        avg=make_averaged_final(score, roll_dice)(i,dice)
        """print('roll' , i ,'avg=',avg)"""
        if max_avg < avg:
            max_avg = avg
            result = i
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    num = 6
    result = swap_strategy(score, opponent_score, 9, num)
    if score < 35 and result != 0:
        return 10
